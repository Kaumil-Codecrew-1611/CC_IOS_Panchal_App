      ...
      <ScrollView keyboardShouldPersistTaps="handled">
        <View style={styles.childContainer}>
          ...
          <View
            ...
            <CustomPersonRelationDropDown selectedVillage={relationship} selectItems={relationshipData} accessibilityLabel="Select Relationship" placeholder="Select Relationship" selctedValue={itemValue => setRelationship(itemValue)} />
            {/* <Picker
          ...
          <View
            ...
            <CustomPersonStatusDropdown selectedVillage={marital_status} accessibilityLabel="Select Marital Status" placeholder="Select Marital Status" selctedValue={itemValue => setMaritalStatus(itemValue)} />
            {/* <Picker
