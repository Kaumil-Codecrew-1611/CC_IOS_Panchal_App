...
import CustomPersonRelationDropDown from '../component/CustomPersonRelationDropDown';
  ...
  const handleRegister = async () => {
    ...
    if (isValid) {
      ...
      api.post(`/addchildUser/${_id}`, forms)
        .then(response => {
          console.log(response.data.savedUser, " ::::::::this is family data")
        ...
        <View style={styles.childContainer}>
          ...
          {forms.map((form, index) => (
            <View key={index}>
              ...
              <View>
                <Pressable onPress={(e) => { e.stopPropagation(); handleToggleDatePicker(index) }}>
                  <TextInput
                    style={[
                      styles.input,
              ...
              <View
                ...
                <CustomPersonRelationDropDown selectedVillage={form.relationship} selectItems={relationshipData} accessibilityLabel="Select Relationship" placeholder="Select Relationship" selctedValue={value => handleRelationshipChange(index, value)} />
                {/* <Picker
              ...
              <View
                ...
                <CustomPersonStatusDropdown selectedVillage={form.maritalStatus} accessibilityLabel="Select Marital Status" placeholder="Select Marital Status" selctedValue={value => handleMaritalStatusChange(index, value)} />
                {/*  <Picker
                  style={[styles.input, { backgroundColor: "none", marginTop: 0 }]}
              ...
              <View
                ...
                <View style={styles.radioContainer}>
                  <Radio.Group
                    ...
                    value={form.gender}
                    onChange={(nextValue) => {
                      handleInputChange(index, 'gender', nextValue)
